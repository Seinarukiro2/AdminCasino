...
Revision ID: c7d0f2d369f8
Revises: 
Create Date: 2024-09-12 20:12:25.721476
...
def upgrade() -> None:
    ...
    sa.Column('webapp_url', sa.String(), nullable=True),
    ...
    sa.Column('hidden_login', sa.String(), nullable=True),
    sa.Column('hall_id', sa.Integer(), nullable=True),
    ...
    op.drop_index('admin_panel_user_login_bb3ae0ab_like', table_name='admin_panel_user')
    op.drop_index('admin_panel_user_project_id_e2f07a46', table_name='admin_panel_user')
    ...
    op.drop_index('admin_panel_project_mac_151bf526_like', table_name='admin_panel_project')
    op.drop_table('admin_panel_project')
    # ### end Alembic commands ###


def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.create_table('admin_panel_project',
    sa.Column('id', sa.BIGINT(), autoincrement=False, nullable=False),
    sa.Column('project_name', sa.VARCHAR(length=255), autoincrement=False, nullable=False),
    sa.Column('project_link', sa.VARCHAR(length=255), autoincrement=False, nullable=False),
    sa.Column('mac', sa.VARCHAR(length=17), autoincrement=False, nullable=False),
    sa.Column('hall_id', sa.INTEGER(), autoincrement=False, nullable=False),
    sa.Column('bot_token', sa.VARCHAR(length=255), autoincrement=False, nullable=True),
    sa.Column('webapp_url', sa.VARCHAR(length=255), autoincrement=False, nullable=True),
    sa.PrimaryKeyConstraint('id', name='admin_panel_project_pkey'),
    sa.UniqueConstraint('hall_id', name='admin_panel_project_hall_id_aef042c7_uniq'),
    sa.UniqueConstraint('mac', name='admin_panel_project_mac_key'),
    postgresql_ignore_search_path=False
    )
    op.create_index('admin_panel_project_mac_151bf526_like', 'admin_panel_project', ['mac'], unique=False)
    ...
    sa.Column('hidden_login', sa.VARCHAR(length=100), autoincrement=False, nullable=False),
    sa.Column('project_id', sa.BIGINT(), autoincrement=False, nullable=True),
    sa.Column('hall_id', sa.INTEGER(), autoincrement=False, nullable=True),
    sa.ForeignKeyConstraint(['project_id'], ['admin_panel_project.id'], name='admin_panel_user_project_id_e2f07a46_fk_admin_panel_project_id', initially='DEFERRED', deferrable=True),
    sa.PrimaryKeyConstraint('id', name='admin_panel_user_pkey'),
    sa.UniqueConstraint('login', name='admin_panel_user_login_key')
    )
    op.create_index('admin_panel_user_project_id_e2f07a46', 'admin_panel_user', ['project_id'], unique=False)
    op.create_index('admin_panel_user_login_bb3ae0ab_like', 'admin_panel_user', ['login'], unique=False)
    op.drop_table('user')
